...
public class Main 
{
    public static void main(String[] args) 
    {
        ...
        JLabel title = new JLabel("Îți place matematica, dar nu știi cum să împarți? Fără probleme, introduceți două numere mai jos.");
        ...
        divide.addActionListener(e -> {
            try {
                ...
                if ("13".equals(divizor)){throw new UnluckyException();}
